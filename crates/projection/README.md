...
- Add optional automatic ENSRainbow healing during live projection if production deployments need real-time `ens.nameByHash` parity without running `labels-heal`.
