...
- Historical block snapshots, recursive nested filters, broad `and/or` composition for all entity/event filters, and `_change_block` filters are still compatibility-expansion work.
